...
@endphp
    ...
    <div class="container-fluid mt--6">
        ...
        {{-- Header Card --}}
        <div class="card mb-4" style="background: linear-gradient(135deg, #7c2d12 0%, #c2410c 50%, #ea580c 100%); border-radius: 12px;">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <p class="text-white-50 mb-0" style="font-size: 0.9rem;">
                            Data jemaat pindah keluar dan atestasi keluar
                        </p>
                    </div>
        ...
        @if(!empty($tanggalAwal))
            <div class="d-flex align-items-center mb-3 p-3" style="border-left: 4px solid #c2410c; background-color: #fff7ed; border-radius: 8px;">
                <i class="fas fa-filter me-3" style="color:#c2410c; font-size:1.2rem;"></i>
                <div style="color:#1a1a1a; font-size:0.85rem; line-height:1.6;">
                    <strong style="color:#c2410c;">Filter aktif:</strong>
                    Menampilkan data atestasi keluar tanggal
                    <span class="badge" style="background-color:#c2410c; color:#fff; font-size:0.8rem;">{{ Carbon::parse($tanggalAwal)->translatedFormat('d F Y') }}</span>
                    s/d
                    <span class="badge" style="background-color:#c2410c; color:#fff; font-size:0.8rem;">{{ Carbon::parse($tanggalAkhir)->translatedFormat('d F Y') }}</span>
                    —
        ...
        <div class="row mb-4">
            <div class="col-xl-3 col-md-6 mb-xl-0">
                <div class="card shadow-sm h-100" style="border-radius: 12px; border-left: 4px solid #ea580c;">
                    <div class="card-body d-flex align-items-center">
                        <div class="d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px; background: rgba(234,88,12,0.1); border-radius: 12px;">
                            <i class="fas fa-sign-out-alt text-warning" style="font-size: 1.3rem;"></i>
                        </div>
                        <div>
                            <h6 class="text-uppercase text-muted mb-1" style="font-size: 0.7rem; letter-spacing: 1px;">Total Keluar</h6>
                            <h3 class="mb-0" style="font-weight: 700; color: #ea580c;">{{ $totalAll }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm h-100" style="border-radius: 12px; border-left: 4px solid #198754;">
                    <div class="card-body d-flex align-items-center">
                        <div class="d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px; background: rgba(25,135,84,0.1); border-radius: 12px;">
                            <i class="fas fa-exchange-alt text-success" style="font-size: 1.3rem;"></i>
                        </div>
                        <div>
                            <h6 class="text-uppercase text-muted mb-1" style="font-size: 0.7rem; letter-spacing: 1px;">Pindah / Atestasi</h6>
                            <h3 class="mb-0" style="font-weight: 700; color: #198754;">{{ $totalPindah }} / {{ $totalAtestasi }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-header border-bottom-0 pb-0" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
                <div class="d-flex align-items-center justify-content-between py-2">
                    <h6 class="mb-0 text-dark">
                        <i class="fas fa-table me-2 text-warning"></i>Daftar Atestasi Keluar
                    </h6>
                    ...
                    <table class="display table align-items-center mb-2 table-hover data-table" id="dataTable">
                        ...
                        <tbody>
                            @forelse($data as $item)
                                <tr style="cursor: pointer; transition: background 0.2s;" onmouseover="this.style.background='#fff7ed'" onmouseout="this.style.background='transparent'">
