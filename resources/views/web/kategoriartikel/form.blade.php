                    ...
                    @endif
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="">Judul Artikel</label>
                                <input class="form-control" type="text" name="judul_artikel" placeholder="mis: Beranda" @if(isset($item)) value="{{ $item->nama_kategori }}" @else value="{{ old('nama_kategori') }}" @endif required>
                            </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="">Kategori Artikel</label>
                                    <select class="form-control select2-hidden-accessible" data-toggle="select" data-select2-id="1" tabindex="-1" aria-hidden="true" name="kategori" required>
                                        <option value="0" class="">Kategori Artikel</option>
                                        @foreach($kategori as $kategori)
                                                <option value="{{ $kategori->id }}" @if((isset($item)) && ($item->kategori_id == $kategori->id)) selected="selected" @endif>{{ $kategori->nama_kategori }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-info bg-gradient-info btn-md px-1 mb-0 form-control" data-confirm-delete="true" href="{{route('admin-kategoriartikel.create')}}">
                                        Kategori lain
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="gambar_cap" placeholder="Judul Gambar" @if(isset($item)) value="{{ $item->gambar_cap }}" @else value="{{ old('gambar_cap') }}" @endif>&nbsp;
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="video_cap" placeholder="Judul Video" @if(isset($item)) value="{{ $item->video_cap }}" @else value="{{ old('video_cap') }}" @endif>&nbsp;
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="dokumen_cap" placeholder="Judul Dokumen" @if(isset($item)) value="{{ $item->dokumen_cap }}" @else value="{{ old('dokumen_cap') }}" @endif>&nbsp;
