...
function sidebarColor(e) {
    ...
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active"),
        ...
        document.querySelector("#sidenavCard") && ((e = ["btn", "btn-sm", "w-100", "mb-0", "bg-gradient-" + a]), (a = document.querySelector("#sidenavCard+.btn")).removeAttribute("class"), a.classList.add(...e));
}
function sidebarType(e) {
    ...
    "bg-white" == a && i
        ...
        "bg-white" == a && n && (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && ((c = o.replace("logo-ct", "logo-ct-dark")), (r.src = c));
}
...
function navbarColorOnResize() {
    sidenav &&
        (1200 < window.innerWidth
            ? referenceButtons.classList.contains("active") && "bg-default" === referenceButtons.getAttribute("data-class")
                ? sidenav.classList.remove("bg-white")
